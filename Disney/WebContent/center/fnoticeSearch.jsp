...
%>	
	...
	<tr onclick="location.href='fcontent.jsp?num=<%=bb.getNum()%>'">
	    ...
	    <td><%=bb.getId() %></td><td width="80px;"><%=bdao.compareDate(bb) %></td><td><%=bb.getReadcount() %></td>
	</tr>
<%
}
%>
...
%>
<div id="table_search">
<input type="button" value="글쓰기" class="btn" onclick="location.href='fwriteBoardForm.jsp'">
</div>
<%
}
%>
