...
<link href="../css/g_subpage.css?ver=1" rel="stylesheet" type="text/css">
...
if(count != 0){
// 리턴할형 List getBoardList(시작하는 행번호, 글개수)
	...
	<tr class="wid" style="margin-right: 3px;">
		<td class="wid">
			<div class="wid">
				<ul class="wid">
					<li class="img">
						<img onclick="location.href='../gallery/gcontent.jsp?num=<%=bb.getNum()%>'" src="../upload/<%=bb.getFile()%>">
					</li>
